...
<div class="ui-grid-b">
  ...
  <div class="ui-block-b"><a class="ui-shadow ui-btn ui-corner-all high_button" href="./?menu=custom&act=search" data-ajax="false">会员管理</a></div>
  <div class="ui-block-c"><a class="ui-shadow ui-btn ui-corner-all high_button" href="#" data-ajax="false">续费充值</a></div>
{^if $user_admin_flg^}
