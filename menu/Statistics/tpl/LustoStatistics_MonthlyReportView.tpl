...
<div class="ui-corner-all custom-corners">
  ...
  <div class="ui-body ui-body-a">
    <fieldset class="ui-grid-b">
      <div class="ui-block-a" style="width:15%!important;"><a href="./?menu={^$current_menu^}&act={^$current_act^}&date={^$prev_param^}" class="ui-shadow ui-btn ui-corner-all ui-icon-carat-l ui-btn-icon-left" data-ajax="false">上一月</a></div>
      ...
      <div class="ui-block-c" style="width:15%!important;"><a href="./?menu={^$current_menu^}&act={^$current_act^}&date={^$next_param^}" class="ui-shadow ui-btn ui-corner-all ui-icon-carat-r ui-btn-icon-right" data-ajax="false">下一月</a></div>
    </fieldset>
